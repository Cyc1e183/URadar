...
class mOP(MutationOP):
  ...
  __exclusion_op__ = {'js':['M02_GIF', 'M02_JPG', 'M02_JSBMP', 'M02_JSGIF', 'M02_PDF', 'M02_PNG', 'M02_ZIP','M04_JPG','M04_PNG','M04_GIF', 'M04_GZIP', 'M04_M4V', 'M04_PAGES', 'M04_PDF', 'M04_TAR_GZ', 'M04_TXT', 'M04_XHT', 'M04_XLA', 'M04_ZIP', 'M12_GIF', 'M12_GZIP', 'M12_JPG', 'M12_M4V', 'M12_PAGES', 'M12_PDF', 'M12_PNG', 'M12_TAR_GZ', 'M12_TXT', 'M12_ZIP']}#['M01_JPG', 'M01_PNG', 'M01_GIF', 'M01_ZIP', 'M01_TAR_GZ', 'M01_PDF', 'M02_JPG', 'M02_PNG', 'M02_GIF', 'M02_ZIP', 'M02_PDF', 'M02_JSBMP', 'M06', 'M08','M10'] # ([classname])when this op used for mutation,
